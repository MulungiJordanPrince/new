    ...
    return (
        <Box id="about">
            <Box marginBottom={4}>
                ...
                <br/><br/>
                Laika originally started as a second-generation deflationary token on BSC, which included the first of its kind scalable auto LPs as well as a max transaction limit to prevent price manipulation. Since its inception, it has grown into a full multi-chain DeFi ecosystem.
                <br/><br/>
                    ...
                    {[
                        {
                            ...
                            subtitle:
                                'Laika Protocol owners get to vote on future changes.',
                            icon: (
                                <svg
                                    height={24}
                                    width={24}
                        ...
                        { 
                            title: 'AstroProtocol Token Farming.',
                            subtitle:
                                'Enjoy farming rewards for doing nothing but waiting. How easy is that?',
                            icon: (
                                <svg
                                    height={24}
                                    width={24}
                        ...
                        {
                            title: 'Same Contract Address on all Chains.',
                            subtitle:
                                'You can use the same contract address to buy/sell Laika Protocol on all supported blockchains.',
                            icon: (
                                <svg
                                    height={24}
                                    width={24}
